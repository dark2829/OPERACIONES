...
public class suma1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_suma1);
        ...
        //obtener nombre
        jugadorString = getIntent().getStringExtra("jugador");
        ...
        if(score <= 9){
            ...
            if(resultado <= 10){
                for(int i =  0 ; i < numero.length; i++){
                    ...
                    if(aleatorio_uno == i){
                        System.out.println("aleatorio1: "+id);
                        ivUno.setImageResource(id);
                    }
                    if(aleatorio_dos == i){
                        System.out.println("aleatorio2: "+id);
